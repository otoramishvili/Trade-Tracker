...
export type TradeSource = "manual" | "imported";
export interface TradeDraft { accountName?: string; date: string; dayOfWeek?: string; session?: TradingSession | ""; symbol: string; position: Position | ""; balanceBefore?: number | null; riskPercent?: number | null; riskAmount?: number | null; rr?: number | null; pnl?: number | null; pnlPercent?: number | null; lots?: number | null; outcome?: TradeOutcome | ""; entryPrice?: number | null; exitPrice?: number | null; entryTime?: string; exitTime?: string; emotion?: string; setup?: string; preTradeNotes?: string; postTradeNotes?: string; chartImages?: string[]; source: TradeSource; provider?: string; connectionId?: string; externalTradeId?: string; externalAccountId?: string; importedAt?: string; }
